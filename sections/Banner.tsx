  ...
  return (
    <div class="h-screen w-screen flex flex-col justify-center items-center relative z-50 gap-16">
          <div class="max-w-[1200px] h-[80%] max-h-[400px] w-3/4 flex justify-between">
              <div class="w-[595px] h-[100%] bg-[url('/photo-1.png')] bg-no-repeat bg-cover rounded-lg"></div>
          ...
          <div class="max-w-[1200px] h-[80%] max-h-[400px] w-3/4 flex justify-between">
              ...
              <div class="w-[595px] h-[100%] bg-[url('/photo-2.png')] bg-no-repeat bg-cover rounded-lg"></div>
          </div>
      </div>
  )
}